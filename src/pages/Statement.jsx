    ...
    <AltLayout>
      <div className="flex justify-between items-center ">
        ...
        <div className='flex flex-col justify-start '>
          <button className="bg-white py-4 w-[12rem] border-[#0018A8] text-[#0018A8] border-2 rounded-lg">Download PDF</button>
        </div>
      ...
      <div className='flex gap-3 my-5 rounded-lg w-full py-4 px-7  bg-white'>
        ...
        <div className=' font-semibold font-manrope'>Statements</div>
      </div>
